...
const int adjustLeftMotorsFwd = 49;  // left motors are weaker than right
const int adjustLeftMotorsRev = 5;   // not so much adj needed in reverse
...
void spinRight(int duration, int speed)
{
  ...
  // set motors to speed out of possible range 0~255
  analogWrite(enR, speed);
...
void loop() {
  ...
  if (buttonRState == HIGH) {
    ...
    driveForward(1500,150);     // duration (in milliseconds) and speed (0 to 255) 
    //turnRight(3000);          // turn 180 degrees RIGHT
    spinRight(910, 150);        // duration (in milliseconds) and speed (0 to 255)
    driveForward(1500,150);     // duration (in milliseconds) and speed (0 to 255) 
    //turnRight(3000);          // turn 180 degrees RIGHT
    spinRight(910, 150);        // duration (in milliseconds) and speed (0 to 255)
  }
  ...
  if (buttonLState == HIGH) {
    ...
    driveForward(1500,150);     // duration (in milliseconds) and speed (0 to 255) 
    //turnLeft(2200);           // turn 180 degrees LEFT
    spinLeft(850, 150);         // duration (in milliseconds) and speed (0 to 255)
    driveForward(1500,150);     // duration (in milliseconds) and speed (0 to 255) 
    //turnLeft(2200);           // turn 180 degrees LEFT
    spinLeft(850, 150);         // duration (in milliseconds) and speed (0 to 255)
  }
